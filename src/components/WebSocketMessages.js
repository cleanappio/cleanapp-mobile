    ...
    return (
      <View style={styles.container}>
        <Text style={styles.disconnectedText}>
          🔌 WebSocket not connected. Connect first to receive messages.
        </Text>
      </View>
    );
  }
    ...
    <View style={styles.container}>
      ...
      <View style={styles.filterContainer}>
        ...
        <TouchableOpacity
          style={[
            styles.filterButton,
            selectedType === "reports" && styles.filterButtonActive,
          ]}
        ...
        >
          <Text
            style={[
              styles.filterButtonText,
              selectedType === "reports" && styles.filterButtonTextActive,
            ]}
          >
            Reports ({messages.filter((m) => m.type === "reports").length})
          </Text>
        </TouchableOpacity>
      </View>
      ...
      >
        {filteredMessages.length === 0 ? (
          <Text style={styles.noMessagesText}>
            📭 No messages received yet. Reports will appear here when
