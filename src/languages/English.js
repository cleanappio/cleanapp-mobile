export default {
  translation: {
    ...
    referral: {
      title: '',
      content: '',
      explainerInviteTitle: 'Invite',
      explainerInviteDesc: 'Invite friends',
      explainerEarnTitle: 'Earn',
      explainerEarnDesc: 'Earn 10% of their KITNs',
      explainerGrowTitle: 'Grow',
      explainerGrowDesc: 'Earn more as they invite others',
    ...
    camerascreen: {
      ...
      prompt:
        'Put the object you want cleaned up into the target and take a picture. Press and hold the photo button to add description.',
      invalidlocation:
        'User Location is invalid. Will you go to Settings and check for Location Setting?',
      addannotation: 'Add Description',
      annotationplaceholder: 'Enter a short problem description (Optional)',
      cancel: 'Cancel',
      submit: 'Submit',
      upload: 'Upload',
      sort: 'Sort',
    ...
    cachescreen: {
      ...
      referCleanapp: 'Share CleanApp for more KITNs!',
      total: 'Total',
      ...
      submit: 'Submit',
      cancel: 'Cancel',
      errAvatarEmpty: 'Avatar cannot be empty',
      editavatar: 'Edit Avatar',
