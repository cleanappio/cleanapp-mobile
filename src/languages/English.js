export default {
  translation: {
    ...
    camerascreen: {
      ...
      prompt: 'Put the object you want cleaned up into the target and take a picture. Press and hold the photo button to add description.',
